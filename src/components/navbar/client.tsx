...
export type NavBarProps = React.PropsWithChildren<{ shouldAnimate?: boolean }>  
const NavBar = ({shouldAnimate}: NavBarProps) => {
    ...
    return (
        <motion.header
            ...
            className={(shouldAnimate ? '' : 'bg-white') + ' ' + "fixed w-full top-0 z-50 shadow-sm"}>
            <div className="container mx-auto px-4 py-3 flex justify-between items-center">
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <Button
                        ...
                        className={(shouldAnimate ? 'border-transparent' : '') + " " + "relative bg-transparent"}
                    >
